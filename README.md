...
-   Host: `somehost_mysql` _db host would need to be the "container_name" of the mysql container from the docker-compose.yml_
-   DB Name: `docker`
-   Username: `root`
-   Password: `pa55w0rd`
...
-   I've now installed Mailpit. PHP is all setup to use it. Just make sure to turn on emails in the admin and Mailpit will catch any outgoing emails from PHP. All you need to do is open up [http://localhost:8025](http://localhost:8025)
